      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          <div className="w-full xl:max-w-[580px] md:h-[820px] flex flex-col justify-center items-start">
            ...
            <p className="mb-6 text-lg max-w-[508px] mx-auto text-center xl:text-left xl:mx-0">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit.
              Blanditiis vel dicta tenetur itaque corrupti molestiae, magnam
              recusandae alias dolor minus?
            </p>
